...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-[92vh] flex items-center justify-center overflow-hidden">
      ...
      {/* LdN Sticker - klebt absolut rechts im Hero, unabhängig vom Content-Flow */}
      <div
        className="absolute top-6 right-2 md:top-1/3 md:right-10 z-20"
      ...
      >
        ...
        >
          ...
          <div className="bg-white rounded-lg px-3 py-1 mt-0.5 w-full text-center leading-tight">
