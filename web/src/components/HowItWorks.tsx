  ...
  return (
    <section id="so-funktionierts" className="py-20 md:py-32 px-6 md:px-10">
      <div className="max-w-5xl mx-auto">
        ...
        <h2 className="font-typewriter text-3xl md:text-4xl lg:text-5xl font-bold text-waldgruen-dark tracking-tight mb-16 md:mb-20 max-w-lg">
          So einfach geht&apos;s
        </h2>
            ...
            <div key={step.number}>
              ...
              >
                ...
                <div style={i % 2 === 1 ? { direction: "ltr" } : undefined}>
                  ...
                  <h3 className="font-typewriter text-2xl md:text-3xl font-bold text-waldgruen-dark mb-4 tracking-tight leading-snug">
                    {step.title}
                  </h3>
                ...
                {/* Number side — large watermark number */}
                <div
