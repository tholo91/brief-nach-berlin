  ...
  return (
    <div className="space-y-2">
      ...
      <button
        ...
        title={uiState === "idle" ? "Deine Worte werden direkt ins Textfeld übernommen. Du kannst den Text danach noch ändern." : undefined}
        className={[
      ...
      >
        ...
        {uiState === "done" && (
          <span className="text-waldgruen">Text eingefügt, du kannst ihn noch anpassen.</span>
        )}
