...
7. Mit etwas Gemeinsamem oder Positivem beginnen, das erhöht die Bereitschaft weiterzulesen.
...
3. Schreibe einen formellen Brief (__MIN_WORDS__ bis __MAX_WORDS__ Wörter) in gepflegtem Deutsch, Sie-Form.
