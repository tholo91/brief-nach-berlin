...
const de: UiCatalog = {
  ...
  howItWorks: {
    ...
    step3Title: "Abschreiben und abschicken", step3Description: "Du bekommst Brief und Adresse per E-Mail. Schreib ihn von Hand ab, unterschreib ihn und schick ihn ab.", panelAriaLabel: "Beispielbrief, Deutschlandkarte oder echte Geschichte", letterTab: "Beispielbrief", mapTab: "Deutschlandkarte", storyTab: "Echte Geschichte", exampleAriaLabel: "Vollständigen Brief und weitere Beispiele lesen", readExample: "Ganzen Beispielbrief lesen", storyAriaLabel: "Die Geschichte von Thomas' Mutter aus Duisburg lesen", storyEyebrow: "Eine echte Geschichte aus Duisburg", storyImageAlt: "Thomas' Mutter mit einem handgeschriebenen Brief in ihrer Wohnung in Duisburg-Homberg", impactTitle: "Meine Mutter schreibt den 1. Brief mit Brief-nach-Berlin", impactPoint1: "Sie wird dazu vom MdB-Büro angerufen", impactPoint2: "Ihr Problem wurde vollständig gelöst", impactPoint3: "Sie rief mich total happy an ☺", impactLinkLead: "Lies", impactLinkAnchor: "hier", impactLinkSuffix: "die ganze Story aus Duisburg",
  },
