...
export interface UiCatalog {
  ...
  howItWorks: {
    ...
    impactPoint2: string;
    impactPoint3: string;
    impactLinkLead: string;
    impactLinkAnchor: string;
    impactLinkSuffix: string;
  };
  ...
  contact: {
    ...
    emailInvalid: string;
    emailSuggestionTitle: string;
    emailSuggestionIntro: string;
    emailSuggestionEntered: string;
    emailSuggestionLabel: string;
    emailSuggestionAccept: string;
    emailSuggestionKeep: string;
  };
  preferences: {
    heading: string;
    intro: string;
...
const de: UiCatalog = {
  ...
  howItWorks: {
    ...
    step3Title: "Abschreiben und abschicken", step3Description: "Du bekommst Brief und Adresse per E-Mail. Schreib ihn von Hand ab, unterschreib ihn und schick ihn ab.", panelAriaLabel: "Beispielbrief, Deutschlandkarte oder erste Erfolge", letterTab: "Beispielbrief", mapTab: "Deutschlandkarte", storyTab: "Erste Erfolge", exampleAriaLabel: "Vollständigen Brief und weitere Beispiele lesen", readExample: "Ganzen Beispielbrief lesen", storyAriaLabel: "Die Geschichte von Thomas' Mutter aus Duisburg lesen", storyEyebrow: "Eine echte Geschichte aus Duisburg", storyImageAlt: "Thomas' Mutter mit einem handgeschriebenen Brief in ihrer Wohnung in Duisburg-Homberg", impactTitle: "Meine Mutter schreibt den 1. Brief mit Brief-nach-Berlin", impactPoint1: "Sie wird dazu vom MdB-Büro angerufen", impactPoint2: "Ihr Problem wurde vollständig gelöst", impactPoint3: "Mama ist jetzt Demokratie-Fan Nr. 1 in Duisburg", impactLinkLead: "Lies", impactLinkAnchor: "hier", impactLinkSuffix: "die ganze Story aus Duisburg",
  },
...
const en: UiCatalog = {
  ...
  howItWorks: { eyebrow: "In three steps", title: "It really is this simple", intro: "You do not need to be a politics expert or know whom to contact. A few notes are enough – Brief-nach-Berlin guides you to a finished letter.", stepLabel: "Step {number}", step1Title: "Describe your concern", step1Description: "Write or say what matters to you. Bullet points are enough.", step2Title: "Add a few details", step2Description: "Enter your postcode and email, then choose tone and length. Brief-nach-Berlin suggests the right political contact and creates your personal letter.", step3Title: "Write it out and send it", step3Description: "You receive the letter and address by email. Copy it out by hand, sign it and send it.", panelAriaLabel: "Sample letter, Germany map or true story", letterTab: "Sample letter", mapTab: "Germany map", storyTab: "True story", exampleAriaLabel: "Read the full letter and more examples", readExample: "Read the full sample letter", storyAriaLabel: "Read the story of Thomas' mother from Duisburg", storyEyebrow: "A true story from Duisburg", storyImageAlt: "Thomas' mother with a handwritten letter in her Duisburg-Homberg apartment", impactTitle: "My mother writes the first letter with Brief-nach-Berlin", impactPoint1: "The constituency office calls her", impactPoint2: "Her problem is fully resolved", impactPoint3: "She called me, completely happy ☺", impactLinkLead: "Read", impactLinkAnchor: "here", impactLinkSuffix: "the full story from Duisburg" },
...
const tr: UiCatalog = {
  ...
  howItWorks: { eyebrow: "Üç adımda", title: "Bu kadar kolay", intro: "Siyaset uzmanı olmanıza veya kime yazacağınızı bilmenize gerek yok. Birkaç not yeter – Brief-nach-Berlin sizi hazır mektuba kadar yönlendirir.", stepLabel: "Adım {number}", step1Title: "Talebinizi anlatın", step1Description: "Sizi neyin ilgilendirdiğini yazın veya sesli olarak anlatın. Anahtar noktalar yeterli.", step2Title: "Bilgileri tamamlayın", step2Description: "Posta kodunuzu ve e-posta adresinizi girin, üslup ile uzunluğu seçin. Brief-nach-Berlin uygun siyasi adresi önerir ve kişisel mektubunuzu hazırlar.", step3Title: "Elinizle yazın ve gönderin", step3Description: "Mektup ve adres e-postanıza gelir. Mektubu elinizle yazın, imzalayın ve gönderin.", panelAriaLabel: "Örnek mektup, Almanya haritası veya gerçek hikâye", letterTab: "Örnek mektup", mapTab: "Almanya haritası", storyTab: "Gerçek hikâye", exampleAriaLabel: "Mektubun tamamını ve başka örnekleri okuyun", readExample: "Örnek mektubun tamamını oku", storyAriaLabel: "Thomas'ın annesinin Duisburg'daki hikâyesini oku", storyEyebrow: "Duisburg'dan gerçek bir hikâye", storyImageAlt: "Thomas'ın annesi Duisburg-Homberg'deki evinde el yazısıyla yazılmış bir mektupla", impactTitle: "Annem Brief-nach-Berlin ile ilk mektubunu yazıyor", impactPoint1: "Seçim bölgesi ofisi onu arıyor", impactPoint2: "Sorunu tamamen çözülüyor", impactPoint3: "Beni çok mutlu aradı ☺", impactLinkLead: "Hikâyenin tamamını", impactLinkAnchor: "buradan", impactLinkSuffix: "Duisburg'dan oku" },
  ...
  footer: { description: "İnsanların siyasi taleplerini doğru yere gönderilecek bir mektuba dönüştürmelerine yardımcı olan bir yan proje.", navigationAriaLabel: "Alt bilgi", use: "Kullanım", project: "Proje", participate: "Katıl", legal: "Yasal", feedback: "Geri bildirim", support: "Brief-nach-Berlin'i destekle", openSource: "Açık kaynak", imprint: "Künye", privacy: "Gizlilik", writeLetter: "Mektup yaz", follow: "Thomas'ı takip et", germanPageSuffix: "Bu sayfa Almanca", letterCount: "{count} mektup" },
  ...
  contact: { heading: "Talebinizden kim sorumlu?", intro: "Posta kodunuz mektubunuzun hangi temsilcilere gitmesi gerektiğini gösterir. Bitmiş mektubu e-posta ile alırsınız.", postalCodeLabel: "Posta kodu *", postalCodePlaceholder: "örn. 10115", postalCodeHint: "Bu, sizin için sorumlu temsilcileri bulur", localityLookup: "{locality} için temsilciler aranıyor", emailLabel: "E-posta adresi *", emailPlaceholder: "siz@eposta.com", emailHint: "Mektubunuz size e-posta ile gelir. Adresiniz yalnızca gönderim için kullanılır ve sonra silinir.", next: "Devam et", postalCodeInvalid: "Lütfen geçerli beş haneli bir posta kodu girin.", emailInvalid: "Lütfen geçerli bir e-posta adresi girin.", emailSuggestionTitle: "E-posta adresini kısaca kontrol edin", emailSuggestionIntro: "Bu adreste yazım hatası olabilir. Öneriyi doğrudan düzenleyebilirsiniz.", emailSuggestionEntered: "Girilen", emailSuggestionLabel: "Önerilen adres", emailSuggestionAccept: "Bu adresi kullan", emailSuggestionKeep: "Girdiğim adres doğru" },
